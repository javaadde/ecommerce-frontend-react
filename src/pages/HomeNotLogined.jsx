          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4 gap-5">
              <button
                ...
                class="bg-transparent border border-off-black text-off-black px-4 py-2 rounded-lg text-sm font-comfortaa font-medium hover:bg-off-black hover:text-off-white transition-all duration-200"
              >
                Sign In
              </button>
              <button
                onclick="window.location.href='http://localhost:5000/signup'"
                class="bg-off-black text-off-white px-4 py-2 rounded-lg text-sm font-comfortaa font-medium hover:bg-dark-gray transition-all duration-200"
              >
                Sign Up
              </button>
            </div>
